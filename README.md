...
SQL is the language to interpret requests, Relational Databases are databases that allow handles to be kept to other tables for reference

- [ ] Why do tables need a `primary key`?

Uniqueness for accessibility
...
Multiple records in a table associated with multiple records in another table
